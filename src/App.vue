...
export default {
  ...
  methods: {
    ...
    triggerAlert(color, message, timeout, dismissible = false) {
      this.$refs.alertComponent.showAlert(color, message, timeout, dismissible);
    },
    triggerAlertHide() {
      this.$refs.alertComponent.hideAlert();
    },
  },
};
</script>
